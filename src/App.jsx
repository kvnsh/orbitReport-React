...
A variable to hold the unique values of the orbitType property of the satellite objects
A function that will filter through the satellites.
...
function App() {
  ...
  //create the second variable(displaySats), called displaySats
  ...
  /*This function(filterByType) will take a parameter that you can call currentType.
